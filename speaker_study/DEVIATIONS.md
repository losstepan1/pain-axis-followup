...
6. **Preregistration additions (to be written in Phase 2):**
   ...
   - Secondary descriptive analysis of the 42 multi-turn items. In these items the swapped label does not create two consecutive User turns, so they partly address entry 4.
